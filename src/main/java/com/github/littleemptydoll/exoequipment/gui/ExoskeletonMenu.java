...
public class ExoskeletonMenu extends AbstractContainerMenu {
    ...
    public ExoskeletonMenu(
        ...
        super(ModMenus.EXOSKELETON.get(), containerId);
        ...
        this.exoskeletonContainer = new ExoskeletonContainer(exoskeleton);
    ...
    private void addEquipmentSlots() {
        ...
        addSlot(new ExoskeletonComponentSlot(
    ...
    private int findEmptySlot(int slot) {
        return slots.get(slot).hasItem() ? -1 : slot;
    }
